    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row ml-2 mr-2">
                ...
                @endif
                <form action="{{route('role.postEdit',['id'=>$role->id])}}" method="POST" style="width:100%;">
                    <div class="col-md-12">
                        ...
                        <div class="card border-info mb-3 pl-0 pr-0 col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="card-body text-info col-md-3">
                                    <label>
                                        <input
                                        {{-- Kiểm tra nếu tồn tại idPermisstion trong danh sách id truyền vào thì checked --}}
                                        {{ $permissionOfRole->contains('id',$PermissionChildItem->id) ? "checked" : '' }}
                                        type="checkbox" value="{{ $PermissionChildItem->id }}" name="permission_id[]" class="checkbox-child" id="">
