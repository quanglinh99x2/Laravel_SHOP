                ...
                <div class="row ml-5">
                    <div class="col-md-8">
                        ...
                        <div class="alert alert-success alert-dismissable">
                         ...
                         @endif
                        <form action = "{{route('slider.postEdit',['id'=>$slider->id])}}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name = "slider_image" class="form-control-file" id="exampleInputEmail1"
                                       aria-describedby=""  >
                                <div class="col-md-12">
                                    <div class="row">
                                        <img class="image_feature" src="{{asset($slider->slider_image)}}" alt="">
