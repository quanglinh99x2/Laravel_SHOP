...
<div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <ul>
            <li class="home"> <a title="Go to Home Page" href="{{ route('home.index') }}">Home</a><span>&raquo;</span></li>
...
{{--========================================================================HIỂN THỊ DANH SÁCH SẢN PHẨM  ===============================================================--}}
        ...
        <li class="item col-lg-3 col-md-4 col-sm-6 col-xs-6 ">
            ...
            <div class="item-inner">
                ...
                <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="{{ route('detail.products',['slug'=> $item->slug]) }}">
                ...
                <div class="info-inner">
                    <div class="item-title"> <a title="Ipsums Dolors Untra" href="{{ route('detail.products',['slug'=> $item->slug]) }}">{{ $item->name }}</a> </div>
