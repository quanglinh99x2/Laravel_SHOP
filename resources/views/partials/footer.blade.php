    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-4 col-xs-12 col-lg-3">
          <div class="footer-logo"><a href="index.html"><img src="quanglinhstore/images/footer-logo.png" alt="fotter logo"></a> </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-12">
            <div class="payment">
              <ul>
                <li><a href="#"><img title="Visa" alt="Visa" src="quanglinhstore/images/visa.png"></a></li>
                <li><a href="#"><img title="Paypal" alt="Paypal" src="quanglinhstore/images/paypal.png"></a></li>
                <li><a href="#"><img title="Discover" alt="Discover" src="quanglinhstore/images/discover.png"></a></li>
                <li><a href="#"><img title="Master Card" alt="Master Card" src="quanglinhstore/images/master-card.png"></a></li>
              </ul>
            </div>
          </div>
        </div>
